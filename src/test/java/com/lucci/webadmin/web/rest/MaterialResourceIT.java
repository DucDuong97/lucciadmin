...
import com.lucci.webadmin.repository.MaterialRepository;
import com.lucci.webadmin.service.MaterialService;
...
public class MaterialResourceIT {
    ...
    public void createMaterial() throws Exception {
        ...
        assertThat(testMaterial.getAmount()).isEqualTo(DEFAULT_AMOUNT);
    ...
    public void updateMaterial() throws Exception {
        ...
        assertThat(testMaterial.getAmount()).isEqualTo(UPDATED_AMOUNT);
