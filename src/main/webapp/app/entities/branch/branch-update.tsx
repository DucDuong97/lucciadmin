  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="lucciadminApp.branch.home.createOrEditLabel">
            <Translate contentKey="lucciadminApp.branch.home.createOrEditLabel">Create or edit a Branch</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : branchEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="adressLabel" for="branch-adress">
