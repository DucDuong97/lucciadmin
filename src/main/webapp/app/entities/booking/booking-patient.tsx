...
import {getEntities, getEntitiesByPatientId} from './booking.reducer';
import { IBooking } from 'app/shared/model/booking.model';
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';

export interface IBookingPatientProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string , id:string }> {}

export const BookingPatient = (props: IBookingPatientProps) => {
  useEffect(() => {
    props.getEntitiesByPatientId(props.match.params.id);
  }, []);
