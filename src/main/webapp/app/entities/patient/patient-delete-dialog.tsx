...
export const PatientDeleteDialog = (props: IPatientDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="lucciadminApp.patient.delete.question">
        <Translate contentKey="lucciadminApp.patient.delete.question" interpolate={{ id: patientEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-patient" color="danger" onClick={confirmDelete}>
