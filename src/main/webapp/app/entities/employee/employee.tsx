  ...
  return (
    <div>
      <h2 id="employee-heading">
        <Translate contentKey="lucciadminApp.employee.home.title">Employees</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="lucciadminApp.employee.home.createLabel">Create new Employee</Translate>
        </Link>
      </h2>
        ...
        {employeeList && employeeList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="lucciadminApp.employee.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('gender')}>
                  <Translate contentKey="lucciadminApp.employee.gender">Gender</Translate> <FontAwesomeIcon icon="sort" />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="lucciadminApp.employee.home.notFound">No Employees found</Translate>
            </div>
          )
        )}
      </div>
