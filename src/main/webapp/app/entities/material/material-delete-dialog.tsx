...
export const MaterialDeleteDialog = (props: IMaterialDeleteDialogProps) => {
  useEffect(() => {
  ...
  const confirmDelete = () => {
    props.deleteEntity(props.materialEntity.id);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="lucciadminApp.material.delete.question">
        <Translate contentKey="lucciadminApp.material.delete.question" interpolate={{ id: materialEntity.id }}>
...
export default connect(mapStateToProps, mapDispatchToProps)(MaterialDeleteDialog);
