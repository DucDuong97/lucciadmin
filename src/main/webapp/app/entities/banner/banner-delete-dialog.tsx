...
export const BannerDeleteDialog = (props: IBannerDeleteDialogProps) => {
  ...
  const confirmDelete = () => {
    props.deleteEntity(props.bannerEntity.id);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="lucciadminApp.banner.delete.question">
        <Translate contentKey="lucciadminApp.banner.delete.question" interpolate={{ id: bannerEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-banner" color="danger" onClick={confirmDelete}>
