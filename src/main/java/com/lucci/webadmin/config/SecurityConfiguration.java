...
import com.lucci.webadmin.security.*;
import com.lucci.webadmin.security.jwt.*;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            .headers()
            .contentSecurityPolicy("default-src 'self'; frame-src 'self' data:; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://storage.googleapis.com; style-src 'self' 'unsafe-inline'; img-src 'self' https://lucci.s3-ap-southeast-1.amazonaws.com data:; font-src 'self' data:")
        .and()
...
//            .antMatchers("/api/**").authenticated()
            ...
            .antMatchers(HttpMethod.POST, "/api/customers").hasAnyAuthority(CONSULTANT)
            .antMatchers(HttpMethod.PUT, "/api/customers/release-customer").hasAuthority(CONSULTANT)
